...
// These macros were defined by the Zephyr Author, need to do the changes in the main.c file according to the MPU6050 library
...
#define MPU6050_RA_XG_OFFS_TC       0x00 //[7] PWR_MODE, [6:1] XG_OFMPU6050_USERCTRL_SIG_COND_RESET_BITFS_TC, [0] OTP_BNK_VLD
...
#define MPU6050_RA_YG_OFFS_USRH     0x15 //[15:0] YG_OFFS_USR USR => User highByte and LowByte
...
#define MPU6050_PWR1_DEVICE_RESET_BIT   BIT(7)
#define MPU6050_PWR1_SLEEP_BIT          BIT(6)
#define MPU6050_PWR1_CYCLE_BIT          BIT(5)
#define MPU6050_PWR1_TEMP_DIS_BIT       BIT(3)
#define MPU6050_PWR1_CLKSEL_BIT         BIT(2)
#define MPU6050_PWR1_CLKSEL_LENGTH      BIT(3)
